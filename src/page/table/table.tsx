...
// 展开函数 codeUnfoldMap[key] 可以设置单个开关, unfold 设置全部开关 代码示例
    ...
    return (
        <div>
            {Object.values(codeUnfoldMap).map((item, index) => <p key={index}>{JSON.parse(item)}</p>)}
            ...
            <fieldset>
                ...
                <CodeDisplay onClick={() => onUnfoldCode('jsx')} style={{width: '20px'}}/>
            ...
            <fieldset>
                ...
                <CodeDisplay onClick={() => onUnfoldCode('sort')} style={{width: '20px'}}/>
            ...
            <fieldset>
                ...
                <CodeDisplay onClick={() => onUnfoldCode('group')} style={{width: '20px'}}/>
            ...
            <fieldset>
                ...
                <CodeDisplay onClick={() => onUnfoldCode('drag')} style={{width: '20px'}}/>
            ...
            <fieldset>
                ...
                <CodeDisplay onClick={() => onUnfoldCode('unfold')} style={{width: '20px'}}/>
            ...
            <fieldset>
                ...
                <CodeDisplay onClick={() => onUnfoldCode('diyUnfold')} style={{width: '20px'}}/>
